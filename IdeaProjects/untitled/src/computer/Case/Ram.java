...
public class Ram {
    ...
    public void getRamGeneration() {
        printResult("ramGeneration", "DDR".concat(String.valueOf(ramGeneration)));
    }

    public void getRamFrequency() {
        printResult("ram frequency", String.valueOf(ramFrequency).concat("MHz"));
    }

    public void getRamVolume() {
        printResult("ram volume", String.valueOf(ramVolume).concat("GB"));
    }

    public void getRamBrand() {
        printResult("ram brand", String.valueOf(ramBrand));
    }
    ...
    public static void getRam(Ram ram){
        System.out.println("// -------------------------------- " +
                "// Ram // ----------------------------- //");
        ram.getRamBrand();
