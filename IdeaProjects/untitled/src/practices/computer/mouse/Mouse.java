...
public class Mouse {
    ...
    public void setMouseBrand() {
        ...
        System.out.println(" " + getMouseBrand() + " Very nice choice ! ");
    }
    public void setMouseConnectionType() {
        ...
        System.out.println(" You have a " + getMouseConnectionType() + " keyboard . ");
    }
    ...
    public void setMouseFunction() {
        ...
        System.out.println(" !! OKAY !! You have a " + getMouseFunction() + " mouse . ");
    }
